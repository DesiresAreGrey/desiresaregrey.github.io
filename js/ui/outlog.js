...
export default class OutLog {
    static minimized = true;
    static async init(minimized) {
        ...
        console.log = function () {
            ...
            for (let i = 0; i < arguments.length; i++) {
                if (typeof arguments[i] == 'number' || typeof arguments[i] == 'boolean') {
                    ...
                    try {
                        const type = arguments[i].constructor?.name ?? "Object";
...
void OutLog.init();
//# sourceMappingURL=outlog.js.map