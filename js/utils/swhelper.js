export default class SWHelper {
    static async getVersion(path = "sw.js") {
        try {
    ...
    static async addVersionToHeader(path = "sw.js") {
        ...
        if (version && headerTitle) {
            headerTitle.innerHTML += `<span style="font-size: 0.55em; opacity: 0.7; margin-left: -3px;">v${version}</span>`;
            return true;
        }
        return false;
    }
}
//# sourceMappingURL=swhelper.js.map